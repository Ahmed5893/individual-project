  ...
  return (
    <div>
      ...
      <Link href={`/product/${product._id}`}>
        <div
          className=" relative flex flex-col md:w-80   pb-6 shadow-sm shadow-black items-center justify-between gap-1 cursor-pointer hover:scale-110 hover:shadow-lg hover:shadow-black"
        >
          {/* {favorite ? (
            <AiTwotoneHeart
