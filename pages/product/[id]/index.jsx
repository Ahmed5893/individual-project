        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <Image
              src={product.image}
              alt={product.name}
              className="lg:w-1/2 h-96 w-full object-cover object-center rounded border border-gray-200"
              width={300}
              height={200}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <ol className="leading-relaxed list-disc">
  {product.description.split('\n').map((item, index) => (
    <li key={index}>{item}</li>
  ))}
</ol>              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
